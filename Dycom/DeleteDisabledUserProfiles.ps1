###############################################################
# This script will populate a list of user profiles on a      #
# remote system. It will then determine which of those users  #
# are disabled in Active Directory. With the subsequent list  #
# of disabled users, it will then delete those profiles using #
# delprof2.exe                                                #
#                                                             #
# This will free up disk space used by profiles of users      #
# that are no longer enabled in AD                            #
###############################################################
