...
#>
    ...
    Process
    {
        ...
        {  
            ...
            $LockedOutEvents = Get-WinEvent -ComputerName ADGC01 -FilterHashtable @{LogName = 'Security'; Id = 4740} -ErrorAction Stop | Sort-Object -Property TimeCreated -Descending
        }
        Catch 
        {          
            Write-Warning $_
...
Get-LockedOutLocation -Identity svc-dii-orion