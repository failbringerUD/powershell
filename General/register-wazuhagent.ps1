...
$agentinfo = $agentexist.Content | ConvertFrom-Json | Select-Object -expand data | Select-Object totalitems

$agentexistid = $agentexist.Content | ConvertFrom-Json | Select-Object -expand data | Select-Object -expand items | Select-Object id # expands the embedded JSON items to retrieve the agent ID
...
Write-Output "y" | & "$($path)manage_agents.exe" "-i $($agent_key)" "y`r`n"
