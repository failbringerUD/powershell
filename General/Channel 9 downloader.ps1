# Channel9 Session Downloader 1.92
# Source: https://gallery.technet.microsoft.com/Channel9-Session-04b2558b
# --------------------------------------------------------------------------------
# 1.93 : Fixed session RSS list
# 1.92 : Added Ignite 2016 events in Atlanta, US
# 1.91 : Added Ignite 2015 events in AU, CN and NZ
...
"@ | Out-Null
	...
	$radiobuttonVideosOnly = New-Object 'System.Windows.Forms.RadioButton'
	...
	$radiobuttonVideoHigh = New-Object 'System.Windows.Forms.RadioButton'
	$radiobuttonVideoMid = New-Object 'System.Windows.Forms.RadioButton'
	...
	$formGetChannel9VidoesSli_Load = {
	    ...
	    $radiobuttonVideoHigh.Checked = $true
...
#	    } -ArgumentList $urlIn | Wait-Job | Receive-Job
        ...
        $rss= Invoke-WebRequest -Uri $urlIn -UserAgent $UserAgent 
        return [xml]$rss
	}
	Function Get-RSSXML
	{
	...
	$buttonDownload_Click = {
	    ...
	    if ($radiobuttonVideosOnly.Checked)
	    {
	...
	$combobox1_SelectedIndexChanged = {
	    ...
	    $Link = $combobox1.Text
	    [System.Windows.Forms.Application]::DoEvents()
        If( $radiobuttonVideoMid.Checked) {
            $VidLink= $Link -replace "mp4high", "mp4"
        }
        Else {
            $VidLink= $Link
        }
	    $script:Videos = Get-RSSXML -InputURL $VidLink
	    [System.Windows.Forms.Application]::DoEvents()
	...
	$formGetChannel9VidoesSli.Controls.Add($groupbox2)
	...
	[void]$combobox1.Items.Add("http://s.ch9.ms/Events/Ignite/2016/RSS/mp4high")
	[void]$combobox1.Items.Add("http://s.ch9.ms/Events/Build/2016/RSS/mp4high")
	[void]$combobox1.Items.Add("http://s.ch9.ms/Events/Microsoft-Azure/AzureCon-2015/RSS/mp4high")
	[void]$combobox1.Items.Add("http://s.ch9.ms/Events/Ignite/Australia-2015/RSS/mp4high")
	[void]$combobox1.Items.Add("http://s.ch9.ms/Events/Ignite/Microsoft-Ignite-New-Zealand-2015/RSS/mp4high")
...
Version: 1.93 - September 26th, 2015
Modified to include additional Ignite events from 2015 and 2016 by Michel de Rooij (eightwone.com)
Original author: Claus T N (PS MVP, blog: www.xipher.dk)
Based on code from Peter Schmidt (msdigest.net)
Originally published as a SharePoint Conf script by Vlad Catrinescu (absolute-sharepoint.com)
...
Credit: Pat Richard for New-Download Function http://www.ehloworld.com"
	...
	# groupbox1
	#
	$groupbox1.Controls.Add($radiobuttonVideosOnly)
	$groupbox1.Controls.Add($radiobuttonSlidesOnly)
	$groupbox1.Controls.Add($radiobuttonVideoSlides)
	$groupbox1.Location = '663, 111'
	$groupbox1.Name = "groupbox1"
	$groupbox1.Size = '139, 101'
	$groupbox1.TabIndex = 6
	$groupbox1.TabStop = $False
	$groupbox1.Text = "Select Download Type"
	#
	# radiobuttonVideosOnly
	#
	$radiobuttonVideosOnly.Location = '22, 27'
	$radiobuttonVideosOnly.Name = "radiobuttonVideosOnly"
	$radiobuttonVideosOnly.Size = '104, 24'
	$radiobuttonVideosOnly.TabIndex = 3
	$radiobuttonVideosOnly.TabStop = $True
	$radiobuttonVideosOnly.Text = "Videos"
	$radiobuttonVideosOnly.UseVisualStyleBackColor = $True
	#
	# radiobuttonSlidesOnly
	#
	$radiobuttonSlidesOnly.Location = '22, 47'
	...
	$radiobuttonVideoSlides.Text = "Videos && Slides"
	$radiobuttonVideoSlides.UseVisualStyleBackColor = $True
	#
	# groupbox2
	#
	$groupbox2.Controls.Add($radiobuttonVideoHigh)
	$groupbox2.Controls.Add($radiobuttonVideoMid)
	$groupbox2.Location = '663, 221'
	$groupbox2.Name = "groupbox2"
	$groupbox2.Size = '139, 91'
	$groupbox2.TabIndex = 7
	$groupbox2.TabStop = $False
	$groupbox2.Text = "Video Quality"
	#
	# radiobuttonVideoHigh
	#
	$radiobuttonVideoHigh.Location = '22, 27'
	$radiobuttonVideoHigh.Name = "radiobuttonVideoHigh"
	$radiobuttonVideoHigh.Size = '104, 24'
	$radiobuttonVideoHigh.TabIndex = 3
	$radiobuttonVideoHigh.TabStop = $True
	$radiobuttonVideoHigh.Text = "High"
	$radiobuttonVideoHigh.UseVisualStyleBackColor = $True
	#
	# radiobuttonVideoMid
	#
	$radiobuttonVideoMid.Location = '22, 47'
	$radiobuttonVideoMid.Name = "radiobuttonVideoMid"
	$radiobuttonVideoMid.Size = '104, 24'
	$radiobuttonVideoMid.TabIndex = 5
	$radiobuttonVideoMid.TabStop = $True
	$radiobuttonVideoMid.Text = "Medium"
	$radiobuttonVideoMid.UseVisualStyleBackColor = $True
	$radiobuttonVideoMid.add_CheckedChanged($radiobuttonVideoMid_CheckedChanged)
